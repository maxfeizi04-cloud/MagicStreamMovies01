...
func LoginUser(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		utils.SetSessionCookies(c, token, refreshToken)
...
func RefreshTokenHandler(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to generate refreshed tokens"})
			return
		}
		...
		utils.SetSessionCookies(c, newToken, newRefreshToken)
